...
import { Briefcase, ArrowLeft, Settings, Award, Plus, Trash2, HelpCircle } from 'lucide-react';
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <div className="flex items-center gap-4 border-b border-slate-200 dark:border-slate-800 pb-4">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Create Position</h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Open a new career job profile, specify parameters, and requirements.</p>
        </div>
      </div>
