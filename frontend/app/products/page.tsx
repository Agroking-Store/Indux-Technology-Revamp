        ...
        <div className="mb-24 flex flex-col items-center text-center">
          ...
          >
            <p className="text-lg font-medium text-slate-700">
              Innovative solutions built to transform industries and drive
              business success.
            </p>
            <p className="text-sm">
              Industry-leading products designed to solve complex business
                      ...
                      <motion.div variants={textItemVariants}>
                        ...
                        <ul className="space-y-3">
                          {project.features.map((feature, i) => (
                            ...
                            >
                              <CheckCircle2
                                className={`mt-0.5 h-4 w-4 shrink-0 ${theme.icon}`}
                              />
        ...
        >
          ...
          <div className="relative z-10 mx-auto flex max-w-2xl flex-col items-center">
            ...
            <p className="mb-10 text-blue-100">
              Contact us to learn more about how our engineering solutions can
              benefit your organization and accelerate your digital
