...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300 overflow-x-clip">
      <main className="flex-1">
        ...
        >
          <div className="sticky top-0 flex h-[100dvh] items-center overflow-hidden z-10 py-6 sm:py-0">
            <motion.div
              ref={trackRef}
              style={{ x: xTransform }}
              className="flex gap-6 sm:gap-8 px-4 sm:px-6 lg:px-8 w-max items-center"
            >
              {/* Intro Title Block */}
              <div className="w-[85vw] sm:w-[60vw] md:w-[50vw] lg:w-[35vw] flex-shrink-0 flex flex-col justify-center pr-4 sm:pr-8 lg:pr-12">
                <div className="inline-flex items-center gap-2 font-bold tracking-wider text-sm text-blue-600 uppercase mb-3 sm:mb-4">
                  <div className="flex gap-1">
                    <span className="w-3 h-3 rounded-full bg-blue-500"></span>
                ...
                <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base md:text-lg leading-relaxed">
                  ...
                  goals, and target audience, conducting in-depth research to craft
              ...
              {[
                ...
                <div
                  key={idx}
                  className="w-[85vw] sm:w-[60vw] md:w-[45vw] lg:w-[30vw] flex-shrink-0 flex flex-col rounded-[2rem] overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 h-[380px] sm:h-[420px] md:h-[450px]"
                >
                  {/* Top Half */}
                  <div className="flex-1 p-6 sm:p-8 md:p-10 relative overflow-hidden flex flex-col justify-center">
                    {/* Watermark Number */}
                    <div className="absolute right-2 md:-right-4 top-1/2 -translate-y-1/2 text-[7rem] sm:text-[8rem] md:text-[12rem] font-bold text-slate-100 dark:text-slate-800/50 pointer-events-none select-none z-0">
                      {card.step}
                    </div>
                    <div className="relative z-10">
                      <h3 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white mb-3 sm:mb-4 tracking-tight">
                        {card.title}
                      </h3>
        ...
        <section className="relative overflow-hidden py-16 sm:py-20 lg:py-24 bg-white dark:bg-slate-950">
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* Header */}
            ...
            <div className="mt-12 sm:mt-16 text-center">
              <Link
                href="/products"
                className="inline-flex items-center justify-center bg-[#0f2e4a] hover:bg-blue-700 text-white px-8 py-5 rounded-full font-bold tracking-wide transition-all shadow-lg shadow-[#0f2e4a]/20 cursor-pointer"
              >
                View All Work
              </Link>
            </div>
        ...
        <section className="relative py-16 sm:py-20 lg:py-24 bg-slate-50 dark:bg-slate-950 overflow-hidden">
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
              ...
              <div className="w-full lg:w-7/12 relative mt-8 lg:mt-12 flex flex-col gap-4 sm:gap-6 overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_5%,black_95%,transparent)]">
