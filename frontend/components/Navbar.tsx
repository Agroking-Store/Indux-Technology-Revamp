...
const LanguageSwitcher = () => {
  ...
  return (
    <div className="flex items-center gap-1 px-3 border rounded-full bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-800 h-10 notranslate">
      ...
      <Select value={currentLang} onValueChange={changeLanguage}>
        ...
        <SelectContent className="rounded-2xl border-slate-200 dark:border-slate-800 shadow-xl">
          ...
          <SelectItem value="mr" className="cursor-pointer font-medium">
            मराठी
          </SelectItem>
          <SelectItem value="hi" className="cursor-pointer font-medium">
            हिन्दी
          </SelectItem>
          <SelectItem value="ar" className="cursor-pointer font-medium">
            العربية
          </SelectItem>
          <SelectItem value="es" className="cursor-pointer font-medium">
            Español
          </SelectItem>
        </SelectContent>
      </Select>
...
function DropdownMenu({
  ...
  data: { title: string; href?: string; main: any[]; side?: any[] };
  pathname: string;
}) {
  const [isHovered, setIsHovered] = useState(false);
