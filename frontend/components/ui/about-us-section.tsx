  ...
  const services = [
    {
      ...
      title: "CRM & ERP",
      description:
        "Streamline your operations with custom CRM and ERP solutions designed to boost efficiency and data management.",
      position: "left",
    },
    {
      ...
      description:
        "Build scalable, high-performance web applications tailored to your business needs using cutting-edge technologies.",
      position: "left",
    },
    {
      ...
      description:
        "Create engaging native and cross-platform mobile experiences that keep your users connected on the go.",
      position: "left",
    },
    {
      ...
      title: "AI Chatbots",
      description:
        "Enhance customer support and engagement with intelligent, conversational AI chatbots available 24/7.",
      position: "right",
    ...
    },
    {
      ...
      description:
        "Automate repetitive tasks and optimize workflows to save time, reduce errors, and focus on growth.",
      position: "right",
    },
    {
      ...
      description:
        "Securely migrate and manage your infrastructure in the cloud for unparalleled scalability and reliability.",
      position: "right",
    },
  ]
    ...
    >
      ...
      >
        <motion.div className="flex flex-col items-center mb-6" variants={itemVariants}>
          ...
          <h2 className="text-4xl md:text-5xl font-light mb-4 text-center">Our Best Services</h2>
          <motion.div
        ...
        <motion.p className="text-center max-w-2xl mx-auto mb-16 text-[#202e44]/80" variants={itemVariants}>
          At Indux Tech, we provide industry-leading digital solutions that empower businesses to thrive. From custom software to intelligent automation, our expertise ensures your success in a digital-first world.
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex justify-center items-center order-first md:order-none mb-8 md:mb-0">
            <motion.div className="relative w-full max-w-xs" variants={itemVariants}>
              ...
              >
                <img
                  src="https://ui-avatars.com/api/?name=Indux+Tech&background=202e44&color=fff&size=512"
                  alt="Indux Tech Logo"
