    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col gap-2">
          ...
          <Input
            ...
            className="h-14 px-4 bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 focus-visible:ring-1 focus-visible:ring-blue-500 rounded-xl shadow-sm text-base"
          />
          {errors.name && (
      ...
      <div className="flex flex-col gap-2">
        ...
        <Controller
          ...
          render={({ field }) => {
            ...
            return (
              <div className="flex h-14 w-full rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 shadow-sm focus-within:ring-1 focus-within:ring-blue-500 transition-colors relative overflow-hidden items-center">
                <Popover open={countryOpen} onOpenChange={setCountryOpen}>
                  <PopoverTrigger type="button" className="flex items-center justify-center px-4 h-full bg-slate-100/50 dark:bg-slate-800/80 border-r border-slate-200 dark:border-slate-700 hover:bg-slate-200/50 dark:hover:bg-slate-700/50 transition-colors shrink-0 outline-none cursor-pointer">
                    {FlagComponent ? (
                  ...
                  >
                    <Command>
                      <CommandInput placeholder="Search country..." className="h-9" autoFocus={false} />
      ...
      <div className="flex flex-col gap-2">
        ...
        <Textarea
          ...
          className="min-h-[120px] p-4 bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 focus-visible:ring-1 focus-visible:ring-blue-500 rounded-xl shadow-sm text-base resize-none"
        ></Textarea>
        {errors.message && (
          <p className="text-red-500 text-xs ml-1">
      ...
      <Button 
        ...
        className="w-fit bg-[#0f2e4a] hover:bg-blue-600 text-white rounded-full px-10 py-7 font-bold tracking-wide text-base transition-all shadow-xl shadow-blue-900/20 mt-4 group disabled:opacity-50 cursor-pointer"
      >
